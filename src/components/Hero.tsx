        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Free audio transcription for voice memos
            </h1>
          ...
          <Dropzone onDrop={onDrop}>
            {({ getRootProps, getInputProps, isDragAccept }) => (
              <section className="rounded-xl bg-white">
                <div
                  className={`h-80 w-96 rounded-xl flex flex-col items-center justify-center ${
                    isDragAccept
                      ? "border-green-500 border-dashed bg-green-500/30"
                      : "bg-white border-gray-500 dark:border-gray-300"
                  } border-4`}
                  {...getRootProps()}
                >
                  <input {...getInputProps()} />
                  <div className="cursor-pointer px-8 py-4 text-lg font-medium text-center text-white bg-emerald-600 rounded-md mb-4">
                    Select files
                  </div>
                  <p className="text-gray-700">Or drag and drop a file</p>
                </div>
              </section>
            )}
          </Dropzone>
      ...
      {/* <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-emerald-600">2000+</span> customers
            worldwide
          </div>
